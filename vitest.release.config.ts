...
export default defineConfig({
  test: {
    include: [
      ...
      'test/db/delivery-workspace-postgres.test.ts',
      'test/db/agent-delivery-interface-postgres.test.ts',
      'test/db/delivery-review-package-postgres.test.ts',
      'test/delivery/*.test.ts',
      'test/release/*.test.ts',
      'test/update/*.test.ts',
      'test/reporting/*.test.ts',
      'test/db/engagement-portfolio-postgres.test.ts',
      ...
      'test/db/archive-state-consistency-postgres.test.ts',
      ...
      'test/git-credential-manager.test.ts',
      ...
      'test/api/migration-routes.test.ts',
      ...
      'test/api/web-server-protected-share-settings.test.ts',
      'test/web/api/activity-parse-timestamp.test.ts',
      'test/web/api/auth-setup-password.test.ts',
      'test/web/api/delivery-pat-auth.test.ts',
      'test/web/api/review-package-upload-routes.test.ts',
      'test/web/api/platform-update-routes.test.ts',
      'test/web/api/protected-share-gateway-routes.test.ts',
      'test/web/api/cloudflare-setup-routes.test.ts',
      ...
      'test/mcp/composite-call-schema-sync.test.ts',
      'test/mcp/composite-docs-sync.test.ts',
      ...
      'test/pipeline/cloudflare-api.test.ts',
      'test/pipeline/connected-publish.test.ts',
      'test/pipeline/docker-sandbox.test.ts',
      'test/operations/application-operation-contract.test.ts',
      'test/operations/migration-operation.test.ts',
      'test/operations/network-maintenance.test.ts',
      'test/migration/*.test.ts',
      'test/pipeline/docker/network.test.ts',
      'test/delivery/delivery-manifest.test.ts',
      'test/delivery/quality-gate-service.test.ts',
      ...
      'test/pipeline/managed-service-resources.test.ts',
      'test/pipeline/managed-service-resources-docker.test.ts',
      'test/resource-routes.test.ts',
      'test/pipeline/neo4j-env-inject.test.ts',
      'test/pipeline/managed-service-linker.test.ts',
      'test/pipeline/port-scan-fallback.test.ts',
      'test/pipeline/protected-public-share.test.ts',
      ...
      'test/service-manager-backup.test.ts',
      'test/tools/deploy-lock-mcp-tools.test.ts',
      'test/tools/git-credential-tools.test.ts',
      ...
      'test/web/delivery-workspace-ui.test.ts',
      'test/web/delivery-artifact-groups.test.ts',
      'test/web/engagement-portfolio-ui.test.ts',
      ...
      'test/web/project-migration-dialog.test.ts',
      'test/web/proxy-pip-format.test.ts',
      'test/web/platform-update-ui.test.ts',
      ...
      'test/web/api/engagement-routes.test.ts',
    ...
    exclude: [
      ...
      'web/**',
      'test/manual-qa/**',
      'test/pipeline/docker/container.test.ts',
      'test/pipeline/docker/exec.test.ts',
      'test/pipeline/docker/image.test.ts',
      'test/pipeline/docker/infra.test.ts',
      'test/pipeline/docker/stream.test.ts',
      'test/pipeline/docker/volume.test.ts',
      'test/docker.test.ts',
