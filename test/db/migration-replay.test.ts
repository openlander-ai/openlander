...
/** Run all 6 migrations with foreign_keys OFF/ON bracketing (matches production logic). */
...
describe('migration idempotency and safety (0003/0004/0005)', () => {
  ...
  describe('Test 1: idempotency — all migrations re-applied to a fully migrated DB', () => {
    ...
    it('__drizzle_migrations has exactly 6 rows after full migration (no duplicates on re-run)', () => {
      runFullMigration(drizzle, sqlite);
