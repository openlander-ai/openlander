...
describe('Project Settings split contract', () => {
  ...
  it('keeps Project Settings group-owned only', () => {
    ...
    expect(projectSettingsSource).not.toMatch(/id: 'env'|id: 'source'|id: 'domains'|id: 'resources'/);
  ...
  it('keeps deployable ownership on Service Detail (v0.1 6-tab IA)', () => {
    ...
    // Settings tabs are cut. See docs/plans/v0.1/frontend/implementation-plan.md
