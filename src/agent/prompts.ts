...
## Your Tools
You have access to deployment tools: deploy_project, stop_project, remove_project, get_logs, list_projects, set_env_vars, expose_public, unexpose_public, get_system_stats, rollback_project, provision_database, deploy_blue_green, debug_build_error, preview_deploy, cleanup_preview, list_previews.
