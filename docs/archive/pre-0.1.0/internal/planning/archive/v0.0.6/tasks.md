# OpenLander v0.0.6 — 상세 개발 Task 목록

> **버전**: v0.0.6 | **상태**: ✅ 38/39 완료 (97%) | **버전 맵**: [`version-map.md`](version-map.md)

> **기준일**: 2025-02-27 (Last updated: 2026-02-27 post-OAuth)
> **범위**: v0.0.6 TUI UI/UX 고도화
> **입력 문서**: requirements.md, v0.0.6-tui-spec.md, v0.0.7-ui-ux-layout.md, v0.0.6-ui-ux-build-compose.md
...
> 참고: `v0.0.7-ui-ux-layout.md` §레이아웃 구조, §3가지 모드, §패널 포커스 관리
...
> 참고: `v0.0.7-ui-ux-layout.md` §모드 1: 모니터링
...
## Phase 3: 배포 모드 — 3/4 완료

> 빌드 시작 시 자동 전환. 파이프라인 시각화 + 빌드 로그.
> 참고: `v0.0.7-ui-ux-layout.md` §모드 2: 배포, `v0.0.6-ui-ux-build-compose.md` §Part 1
...
## Phase 4: 디버깅 모드 — ✅ 3/3 완료

> 특정 프로젝트 상세 + 실시간 로그.
> 참고: `v0.0.7-ui-ux-layout.md` §모드 3: 디버깅
...
> 참고: `v0.0.6-ui-ux-build-compose.md` §Part 2
...
- **구현**:
  ...
  3. 추가/수정/삭제 인라인 UI
  4. 변경 후 재배포 제안
- **의존성**: v0.0.9-10-unified-spec.md Part 4
