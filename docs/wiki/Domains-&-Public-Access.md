...
Project Detail → **Domains** tab → Add Domain

#### Via MCP

```
map_domain(project_name: "my-app", domain: "app.example.com")
```
...
A project can have multiple domains mapped:

```
map_domain(project_name: "my-app", domain: "app.example.com")
map_domain(project_name: "my-app", domain: "www.example.com")
```
