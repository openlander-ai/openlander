 ...
 * Sidebar — v0.1 IA.
 *
 * Per docs/plans/v0.1/README.md (final design lock):
 *
  ...
  return (
    ...
    >
      ...
      <div className="flex h-[var(--ol-topbar-h)] items-center gap-2.5 border-b border-[color:var(--ol-border-subtle)] px-4">
        <span
          aria-hidden
          className="grid h-7 w-7 place-items-center rounded-md bg-[color:var(--ol-primary-soft)] text-[13px] text-[color:var(--ol-primary)]"
        >
          {BRAND.glyph}
        </span>
        {!collapsed && (
      ...
      {/* Account card pinned at bottom — single-admin v0.1. The legacy direct
          ...
          docs/plans/v0.1/README.md. The legacy "self-hosted vX.Y.Z" version
