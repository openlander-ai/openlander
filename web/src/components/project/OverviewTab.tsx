...
export function OverviewTab({
  ...
  return (
    <div className="flex flex-col h-full min-h-0 overflow-auto p-6 space-y-6 bg-bg-app">
      ...
      {/* Deploy Terminal — full width, compact when idle */}
      <section
        className={cn(
          'rounded-xl border border-[hsl(var(--border))] bg-bg-panel overflow-hidden shadow-sm',
          projectStatus === 'building' || isTimelineStreaming ? 'min-h-[400px]' : 'max-h-[220px]',
        )}
      >
        <LocalErrorBoundary>
      ...
      {/* Infrastructure + Quick Actions — side by side */}
          ...
          <div className="space-y-4">
            <div className="flex flex-col gap-1">
              ...
              <div className="flex items-center gap-2">
                <div
                  className={cn('h-2.5 w-2.5 rounded-full shrink-0', getStatusColor(projectStatus))}
                />
