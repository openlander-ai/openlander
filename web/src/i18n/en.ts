export const translations = {
  ...
  operations: {
    ...
    incidentHistory: 'Issue History',
    noIncidents: 'No issues recorded',
    timeline: 'Timeline',
    noTimelineEvents: 'No timeline events available',
    loadingFailed: 'Failed to load operations data',
    title: 'Operations Center',
    description: 'Monitor agent activity, active issues, and system health across all projects.',
    approvals: {
  ...
  opsV2: {
    ...
    empty: {
      ...
      noActiveIssuesDesc: 'When an incident occurs, it will appear here.',
    ...
    incident: {
      ...
      noEventsDesc: 'No events recorded for this incident.',
      recovering: 'Recovery in progress...',
      loadError: 'Failed to load incident',
    },
  },
  ops: {
    live: 'Live',
  ...
  postmortemsTab: {
    noPostmortems: 'No postmortems yet',
    emptyMessage:
      'Reports are auto-generated after successful recoveries. They are kept in memory and reset when the server restarts.',
