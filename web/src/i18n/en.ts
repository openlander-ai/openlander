export const translations = {
  ...
  activity: {
    eventTitle: {
      ...
      publicAccessEnabled: 'Protected share enabled',
      publicAccessDisabled: 'Protected share stopped',
      publicAccessCodeRotated: 'Protected share code changed',
      publicAccessVerificationFailed: 'Protected share authentication failed',
  ...
  projectDetail: {
    ...
    servicesGuide: {
      ...
      quickActions: {
        ...
        publicAccess: 'External sharing',
        checkingShare: 'Checking share status…',
        retryShareStatus: 'Retry sharing status',
        shareProtected: 'Share with access code',
        shareCloudflare: 'Share with Cloudflare',
        cloudflareBusy: 'Cloudflare is used by another app',
        shareProvisioning: 'Checking external access…',
        shareStopping: 'Stopping external access…',
        openPublicUrl: 'Open public URL',
        stopShare: 'Stop external sharing',
        shareReady: 'The public URL is ready.',
        shareStopped: 'External sharing stopped.',
  ...
  webServer: {
    ...
    protectedShare: {
      ...
      securityPolicy:
        'Security policy: {attempts} attempts per {minutes} minutes · sessions expire after {days} days · changing the code signs out existing visitors.',
      ...
      activeShares: 'Public Applications',
      activeSharesDescription: 'Manage every Application shared directly from this server.',
      noActiveShares: 'No Applications are currently shared directly.',
      copyUrl: 'Copy URL',
      urlCopied: 'Public URL copied.',
      ...
      rotateDescription:
        'The current code and every signed-in visitor session will stop working immediately.',
      rotateConfirm: 'Generate new code',
      codeRotated: 'A new access code was generated.',
      rotateFailed: 'Could not generate a new access code.',
      newCodeTitle: 'New access code',
      newCodeDescription:
        'Copy this code for {application}. OpenLander will not show it again after you close this window.',
      codeCopied: 'Access code copied.',
      stopShare: 'Stop public access',
      stopTitle: 'Stop public access?',
      stopDescription:
        '{hostname} will no longer be reachable. You can share it again later with the same URL.',
      stopConfirm: 'Stop public access',
      shareStopped: 'Public access stopped.',
      stopFailed: 'Could not stop public access.',
    },
    publicAccess: {
      ...
      repairedToast: 'Cloudflare connection recovered.',
      repairFailed: 'Could not repair the Cloudflare connection.',
