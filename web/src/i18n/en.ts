  ...
  services: {
    ...
    managedDetail: {
      ...
      settings: {
        ...
        deleteBody: 'Delete this service container and its persistent volume.',
        delete: 'Delete service',
        deleting: 'Deleting…',
        confirmTitle: 'Delete infrastructure service',
        confirmDescription:
          'This deletes the service container, stored credentials, and persistent volume. This action cannot be undone.',
