export const translations = {
  ...
  agentGuide: {
    ...
    content: {
      ...
      deleteService: {
        heading: 'Ask your agent to delete this Application',
        lead: 'You can allow stop and delete actions for this Project in the conversation. The permission persists, so each service does not need a separate Web approval.',
        prompt: {
          delete:
            'Allow stop and delete actions for Project {projectName}, then delete {serviceName}. Keep its data volumes.',
          checkReferences:
            'Check which services depend on {serviceName} in Project {projectName} before deleting it.',
        },
        hint: {
          checkReferences:
            'MCP deletion keeps data volumes. Dependency checks and service-specific restrictions still apply.',
        },
      },
      removeDomain: {
