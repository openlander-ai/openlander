export const translations = {
  ...
  setup: {
    ...
    password: {
      ...
      secretPlaceholder: 'Setup secret 입력',
      secretHint: '첫 부팅 시 서버 콘솔에 출력된 32자리 secret을 입력하세요.',
      secretEmpty: 'Setup secret을 입력해주세요',
  ...
  operations: {
    tab: '운영',
    activeIncidents: '현재 장애',
    circuitBreaker: '자동 복구 상태',
    incidentHistory: '장애 기록',
    noIncidents: '기록된 장애 없음',
    timeline: '타임라인',
    noTimelineEvents: '타임라인 이벤트 없음',
    loadingFailed: '운영 데이터를 불러오지 못했습니다',
    title: 'Operations Center',
    description: '전체 프로젝트의 에이전트 활동, 장애 상황, 시스템 상태를 모니터링합니다.',
    approvals: {
      title: '승인 대기',
      approve: '승인',
      reject: '거부',
    ...
    events: {
      ...
      unknown: '알 수 없는 이벤트',
      recovery_started: '복구 시작됨',
      recovery_failed: '복구 실패',
      recovery_completed: '복구 완료',
      recovery_degraded: '복구 부분 실패',
      recovery_blocked: '복구 차단됨',
      recovery_stopped: '복구 중단됨',
      rollback_skipped: '롤백 건너뜀',
      rollback_failed: '롤백 실패',
      rollback_failed_due_to_policy: '정책에 의해 롤백 차단됨',
      webhook_skipped: '웹훅 건너뜀 (프로젝트 상태)',
      approval_pending: '승인 대기 중',
      approval_approved: '승인됨',
      approval_rejected: '거부됨',
      circuit_breaker_open: '자동 복구 중단됨',
      circuit_breaker_reset: '자동 복구 재설정됨',
      cascade_detected: '연쇄 장애 감지됨',
      cleanup: '정리 작업',
      alert_sent: '알림 전송됨',
    },
    activity: {
  ...
  opsV2: {
    ...
    page: {
      title: '운영 센터',
      description: '모든 시스템 이벤트, 활성 장애, 대기 중인 작업의 통합 타임라인입니다.',
    },
    statusStrip: {
      healthState: '시스템 상태',
      incidentCount: '{count}개 활성 장애',
      approvalCount: '{count}개 승인 대기',
      circuitBreakerCount: '{count}개 복구 중단',
      agentStatus: '에이전트 상태',
      healthy: '정상',
      degraded: '불안정',
      critical: '위험',
    ...
    empty: {
      noActivityTitle: '활동 없음',
      noActivityDesc: '현재 운영 활동이 없습니다. 모든 시스템이 정상입니다.',
      filteredTitle: '결과 없음',
      filteredDesc: '선택한 필터에 해당하는 활동이 없습니다.',
      noActiveIssues: '활성 장애 없음',
      noActiveIssuesDesc: '장애가 발생하면 여기에 표시됩니다.',
      noPendingApprovals: '대기 중인 승인이 없습니다',
      allSystemsNormal: '모든 시스템 정상',
      noSearchResults: '검색 결과가 없습니다',
      noSearchResultsDesc: '검색어를 변경해 보세요.',
    },
    graph: {
      title: '의존성 그래프',
      emptyTitle: '연결된 서비스 없음',
      emptyDesc: '서비스가 연결되면 의존성 그래프가 표시됩니다.',
      feedView: '활동 피드',
      graphView: '의존성 그래프',
    ...
    titles: {
      ...
      deployFailed: '배포 실패',
      deployCrash: '배포 중 오류',
      circuitBreakerOpen: '복구 일시 중지됨',
      circuitBreakerReset: '복구 재설정됨',
      recoveryBlocked: '복구 차단됨',
    },
    severity: {
      critical: '위험',
      warning: '경고',
    ...
    incident: {
      ...
      actionsTaken: '조치 내역',
      trigger: '트리거',
      noEventsTitle: '이벤트 없음',
      noEventsDesc: '이 장애에 기록된 이벤트가 없습니다.',
      recovering: '복구 진행 중...',
      loadError: '장애 상세 정보를 불러오지 못했습니다',
    },
  },
  ops: {
    live: '라이브',
    ...
    repeatedIncidentsGrouped: '건의 반복된 장애가 병합됨',
    zeroRepeatedIncidents: '반복된 장애 없음',
    recoveryStatusLabel: '자동복구 상태',
    lastAlert: '최근 알림',
    noAlertsConfigured: '알림 미설정',
    allClear: '장애가 없습니다',
    noActiveIssuesDetected: '모든 시스템이 정상적으로 동작 중입니다.',
    noRuntimeIncidents: '런타임 장애 없음',
  ...
  project: {
    ...
    header: {
      ...
      action: {
        ...
        blueGreen: '블루-그린 배포',
        more: '더 많은 작업',
        aiPipelineTooltip: 'AI가 전체 파이프라인을 처리합니다',
      },
      share: {
        share: '공유',
        shared: '공유됨',
  ...
  deploymentsList: {
    title: '배포',
    noDeployments: '아직 배포가 없습니다',
    noDeploymentsFilter: '현재 필터와 일치하는 배포가 없습니다',
    emptyHint: '첫 번째 프로젝트를 배포하여 기록을 확인하세요.',
    projectCommit: '프로젝트 / 커밋',
    status: '상태',
    trigger: '트리거',
    duration: '소요 시간',
    time: '시간',
  ...
  approvalsTab: {
    noPendingApprovals: '대기 중인 승인이 없습니다',
    emptyMessage: '자동 복구 작업이 검토가 필요할 때 여기에 표시됩니다.',
    requested: '요청됨',
    approve: '승인',
    reject: '거부',
  },
  ...
  usageTab: {
    noUsage: 'AI 사용 기록이 없습니다',
    emptyMessage: 'AI 기능이 활성화되면 사용 데이터가 표시됩니다.',
    totalCost: '총 비용',
    totalTokens: '총 토큰',
    in: '입력',
    out: '출력',
