export const translations = {
  ...
  setup: {
    ...
    password: {
      ...
      lengthHint: '최소 12자 이상이어야 합니다.',
      secretEmpty: 'Setup secret을 입력해주세요',
      mismatch: '비밀번호가 일치하지 않습니다',
      empty: '비밀번호를 입력해주세요',
      tooShort: '비밀번호는 최소 12자 이상이어야 합니다',
      saving: '설정 중...',
      submit: '비밀번호 설정 후 계속',
  ...
  mcpServer: {
    ...
    tokens: {
      ...
      regenerateSuccess: '토큰이 재발급되었습니다. Claude Desktop 설정을 새 값으로 갱신하세요.',
      ...
      passwordHint:
        '비밀번호처럼 취급하세요. 토큰 하나가 모든 프로젝트 접근 권한을 가집니다. 분실했나요? 재발급하세요.',
      issuedAt: '{when} 발급',
      loadFailed: '토큰 목록을 불러오지 못했습니다',
    },
    setup: {
      title: '설정',
      subtitle: 'Claude Desktop의 MCP 설정에 OpenLander를 추가하세요.',
      copyConfig: '설정 복사',
      restartHint:
        '저장 후 Claude Desktop을 재시작하세요. 첫 호출 시 위 상태가 연결됨으로 바뀝니다.',
    },
    recent: {
      title: '최근 에이전트 호출',
