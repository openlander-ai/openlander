export const translations = {
  ...
  repositoryKeys: {
    ...
    wizard: {
      ...
      publicKey: '공개키',
      readOnlyWarning:
        'GitHub에서 “Allow write access”를 선택하지 마세요. OpenLander는 clone과 배포를 위한 읽기 권한만 필요합니다.',
      verifiedTitle: '저장소 접근이 검증되었습니다',
      verifiedBody: 'OpenLander가 {repository} 저장소를 안전하게 clone할 수 있습니다.',
    },
    delete: {
      title: '저장소 키를 삭제할까요?',
      body: '“{name}” 키가 OpenLander에서 영구 삭제됩니다. GitHub의 공개키는 별도로 삭제해야 합니다.',
    ...
    errors: {
      ...
      copy: '공개키를 복사하지 못했습니다. 직접 선택해 복사하세요.',
  ...
  delivery: {
    ...
    beta: 'Beta',
    description:
      '검토 산출물, 고객 피드백, 결정, Gate, 배포 증거와 최종 불변 Receipt를 하나의 Project 흐름에 보존합니다.',
    loading: 'Delivery workspace를 불러오는 중...',
    none: '없음',
    immutable:
      '이 Delivery는 최종 확정되어 변경할 수 없습니다. 수정 전달은 이 Delivery를 참조하는 새 Delivery로 만드세요.',
    fields: {
      title: '제목',
      type: 'Delivery 유형',
      maturity: '성숙도',
      summary: '목적 및 범위',
      limitations: '알려진 제한사항',
      limitationsPlaceholder: '제한사항을 입력하거나 “없음”을 명시하세요.',
      predecessor: '선행 Delivery',
      noPredecessor: '선행 Delivery 없음',
    },
    type: {
    ...
    workflow: {
      title: 'Delivery 진행 단계',
      next: '다음 권장 단계: {step}',
      ready: '모든 증빙 조건을 충족했습니다. Receipt를 검토하고 최종 확정하세요.',
      complete: 'Delivery와 불변 Receipt가 모두 확정되었습니다.',
      readinessReady: 'Receipt 준비 완료',
      blocked: 'Readiness 검사 {count}개 남음',
      steps: {
        overview: '범위',
        artifacts: '산출물',
        review: '고객 검토',
    ...
    actions: {
      ...
      unlink: '연결 해제',
      preview: '미리보기 생성',
      finalize: 'Receipt 최종 확정',
      downloadReceipt: 'Receipt 다운로드',
    },
    empty: {
      title: '아직 Delivery가 없습니다',
      description:
        '검토 산출물, 고객 결정, 릴리스 증거를 지속 가능한 인계 기록으로 남길 때 생성하세요.',
    },
    overview: {
      title: 'Delivery 개요',
      description: '유형에 따라 최종 확정에 성공한 Production 배포가 필요한지 결정됩니다.',
    },
    artifacts: {
      uploadTitle: '산출물 리비전 업로드',
      uploadDescription:
        'HTML은 다운로드만 지원합니다. Receipt에 포함하려면 같은 논리 키와 리비전의 동반 PDF를 업로드하세요.',
      file: '파일',
      logicalKey: '논리 키',
      revision: '리비전',
      kind: '산출물 종류',
      order: 'Receipt 순서',
      companionFor: 'HTML 동반 PDF',
      noCompanion: '대상 HTML 선택 (선택)',
      listTitle: '산출물 리비전',
      empty: '업로드된 산출물이 없습니다.',
      kindValue: {
        review_html: '검토 HTML',
        companion_pdf: '동반 PDF',
        markdown: 'Markdown',
        qa_report: 'QA 보고서',
        data_report: 'Data 보고서',
        image: '이미지',
        other: '기타',
      },
      statusValue: {
    ...
    review: {
      feedbackTitle: '피드백 원문 보존',
      feedbackDescription:
        'Slack, 이메일, Teams, 회의 내용을 붙여넣으세요. 출처 URL은 선택 메타데이터입니다.',
      authorPlaceholder: '작성자 표시명',
      sourceUrlPlaceholder: '출처 URL (선택)',
      ...
      itemsDescription:
        '외부 에이전트는 proposed 초안만 제출합니다. 확정된 질문과 수정 요청은 최종 확정 전에 모두 해소해야 합니다.',
      noItems: '구조화된 검토 항목이 없습니다.',
      aiDraft: 'AI 초안',
      resolutionPlaceholder: '해소 내용 및 근거',
      approvalTitle: '고객 승인 증거',
      approvalDescription:
        '승인자 표시명, 승인 문구, 시각, 출처와 승인 대상 산출물 리비전을 기록합니다.',
      approverPlaceholder: '승인자 표시명',
      approvalExcerptPlaceholder: '승인 문구 또는 원문 일부',
    ...
    gates: {
      ...
      description: 'OpenLander는 외부 CI와 에이전트 결과를 기록하며 QA 자체를 실행하지 않습니다.',
      required: '필수',
      optional: '선택',
      summaryPlaceholder: '결과 요약',
      reportArtifact: 'Gate 보고서 산출물',
      noReport: '보고서 산출물 없음',
      waiverPlaceholder: '면제 사유 필수',
      acceptWarning: '이 Delivery에서 해당 warning을 명시적으로 수용합니다.',
      requiredToggle: '이 Gate를 필수로 지정',
      type: {
        review: '검토',
        qa: 'QA',
        data: '데이터',
    ...
    deployments: {
      linkTitle: 'Production 배포 증거 연결',
      linkDescription: '이 Project에서 성공한 Production 배포만 연결할 수 있습니다.',
      deployIdPlaceholder: 'Deployment ID',
      listTitle: '연결된 배포',
      empty: '연결된 배포 증거가 없습니다.',
      noCommit: '커밋 정보 없음',
      relation: {
        candidate: '후보',
        released: '출시',
    ...
    receipt: {
      ...
      readinessDescription: '전체 증빙 PDF를 미리보고 최종 확정하려면 모든 검사를 통과해야 합니다.',
      pageEstimate: '예상 전체 분량: {count}페이지',
      actionsTitle: 'Receipt',
      finalizeWarning:
        '최종 확정하면 Delivery와 증빙 스냅샷이 영구 잠깁니다. 먼저 전체 PDF를 확인하세요.',
      finalizedTitle: '불변 Receipt 확정 완료',
    },
    settings: {
      nav: 'Delivery Receipt',
      action: 'Receipt 설정',
      title: 'Delivery Receipt 테마',
      description: '증빙 레이아웃은 고정한 채 조직명과 색상 등 문서 정체성을 설정합니다.',
      organization: '조직명',
      documentName: '문서명',
      primaryColor: '기본색',
      logo: 'Receipt 로고',
      ...
      logoSaved: 'Receipt 로고를 저장했습니다.',
      logoError: 'Receipt 로고를 업로드하지 못했습니다.',
      locale: 'Receipt 언어',
      korean: '한국어',
      english: '영어',
      footer: '푸터',
      defaultGates: '기본 Gate 템플릿',
      defaultGatesDescription:
        '새 Delivery가 이 필수 조건을 복사합니다. 각 Delivery에서는 draft 상태일 때만 조정할 수 있습니다.',
      save: 'Receipt 설정 저장',
      saving: '저장 중...',
      saved: 'Receipt 설정을 저장했습니다.',
      loadError: 'Receipt 설정을 불러오지 못했습니다.',
      saveError: 'Receipt 설정을 저장하지 못했습니다.',
    },
    messages: {
      saved: 'Delivery를 저장했습니다.',
      statusChanged: 'Delivery 상태를 변경했습니다.',
      uploaded: '산출물을 업로드했습니다.',
      artifactApproved: '산출물을 승인했습니다.',
      feedbackRecorded: '피드백을 기록했습니다.',
      approvalRecorded: '고객 승인 증거를 기록했습니다.',
      referenceAdded: '외부 근거를 추가했습니다.',
      gateRecorded: 'Gate 결과를 기록했습니다.',
      gateTemplateSaved: 'Gate 필수 여부를 저장했습니다.',
      deployLinked: 'Production 배포를 연결했습니다.',
      deployUnlinked: '배포 증거 연결을 해제했습니다.',
      previewGenerated: 'Receipt 미리보기를 생성했습니다.',
      finalized: 'Receipt를 확정하고 Delivery를 잠갔습니다.',
    },
    errors: {
      load: 'Deliveries를 불러오지 못했습니다.',
      create: 'Delivery를 만들지 못했습니다.',
      action: 'Delivery 작업에 실패했습니다.',
      notFound: 'Delivery를 찾을 수 없습니다',
    },
  },
  engagements: {
    sidebar: 'Engagements',
    ...
    subtitle:
      'Project를 내부 FDE 납품 Engagement로 묶고 여러 Project의 blocker를 한 곳에서 찾습니다.',
    search: '고객명 또는 Engagement 검색',
    filterStatus: '상태',
    showArchived: 'Archived 포함',
    loading: 'Engagement를 불러오는 중',
    emptyTitle: '아직 Engagement가 없습니다',
    emptyDescription:
      '내부 Engagement를 만들고 기존 Project를 연결하세요. Runtime과 Delivery 이력은 변경되지 않습니다.',
    emptySearchTitle: '조건에 맞는 Engagement가 없습니다',
    emptySearchDescription: '검색어나 상태 필터를 조정하세요.',
    notFound: 'Engagement를 찾을 수 없습니다',
    recentActivity: '최근 활동 {time}',
    chipAria: '{title} Engagement 열기',
    projectDeliveryCount: 'Delivery {count}개',
    blockerCount: 'Blocker {count}개',
    status: {
      all: '전체',
      active: '진행 중',
      on_hold: '보류',
    ...
    metrics: {
      projects: 'Projects',
      deliveries: 'Deliveries',
      blockerDeliveries: 'Blocker가 있는 Delivery',
      blockers: 'Blockers',
    },
    fields: {
      customer: '고객명',
    ...
    actions: {
      ...
      archive: 'Archive',
      unarchive: 'Unarchive',
      back: 'Engagements로 돌아가기',
      linkProject: 'Project 연결',
      unlinkProjectAria: '{project} 연결 해제',
    },
    create: {
      title: 'Engagement 만들기',
      description: '내부 FDE 관리를 위한 분류입니다. 고객 계정은 생성하지 않습니다.',
    },
    edit: {
      title: 'Engagement 수정',
      description: '연결된 Delivery 증거를 바꾸지 않고 내부 분류만 수정합니다.',
    },
    link: {
      title: 'Project 연결',
      description:
        '미분류 Project만 선택할 수 있습니다. 한 Project는 하나의 Engagement에만 속합니다.',
      selectProject: '미분류 Project 선택',
      noUnassigned: '모든 활성 Project가 이미 분류되어 있습니다.',
    },
    sections: {
      projects: {
        title: 'Projects와 runtime',
        description: '연결된 Project와 현재 종합 runtime 상태입니다.',
        empty: '연결된 Project가 없습니다. 직접 연결하기 전까지 기존 Project는 미분류 상태입니다.',
      },
      deliveries: {
        title: 'Delivery 진행 상태',
        description: 'Project별 Delivery maturity와 상태입니다.',
        empty: 'Project를 연결하면 Delivery가 표시됩니다.',
        noneForProject: '이 Project에는 Delivery가 없습니다.',
      },
      blockers: {
        title: 'Blockers',
        description:
          'Runtime 오류, revision 요청, 필수 Gate 실패, 미확인 warning, 미해결 confirmed work입니다.',
        empty: '현재 blocker가 없습니다.',
      },
      activity: {
        title: '최근 활동',
        description: 'Engagement, Project, Delivery 활동을 한 타임라인에서 봅니다.',
        empty: '최근 활동이 없습니다.',
      },
    },
    blocker: {
      project_error: 'Project runtime 오류',
      revision_requested: 'Revision 요청',
      required_gate_failed: '필수 Gate 실패',
      warning_unacknowledged: '확인되지 않은 Gate warning',
      work_item_unresolved: '미해결 confirmed work',
    },
    errors: {
      load: 'Engagement를 불러오지 못했습니다.',
      create: 'Engagement를 만들지 못했습니다.',
      loadDetail: 'Engagement를 불러오지 못했습니다.',
      update: 'Engagement를 수정하지 못했습니다.',
      archive: 'Archive 상태를 변경하지 못했습니다.',
      link: 'Project를 연결하지 못했습니다.',
      unlink: 'Project 연결을 해제하지 못했습니다.',
    },
  },
