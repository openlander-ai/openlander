...
| **v1.0.0**      | Stable Release               | TBD    | RecoveryCoordinator (7-condition eligibility gate), multi-provider LLM (8 LLM providers), approval gates for high-risk recovery, AI usage dashboard, operations center, 4 composite MCP tools (70 actions; +11 platform tools opt-in) |
